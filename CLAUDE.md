...
**全期回測彙整（誠實版 Fix4，各幣使用目前實盤策略參數）**：

> BTC = vwap_bb_rsi（trail=2.0, sl=1.0, 4h）  
> ETH = adaptive_combo ★（atrSl=1.5, 4h）  
> SOL = vwap_bb_rsi（trail=2.0, sl=1.0, 4h）  
> BNB = vwap_bb_rsi（trail=2.0, sl=1.0, 4h）  
> ★ ETH 於 2026-05-24 從 vwap_bb_rsi 換成 adaptive_combo；表格全年均以 adaptive_combo 參數回測，反映目前策略的歷史預期績效

| 期間 | BTC | ETH ★ | SOL | BNB | 4幣平均 |
|------|-----|--------|-----|-----|--------|
| 2021 🐂 | -13.8% | +0.8% | +224.9% | +99.9% | **+78.0%** |
| 2022 🐻 | -61.8% | -2.9% | -72.4% | -35.7% | **-43.2%** |
| 2023 🐂 | +68.2% | +25.9% | +155.9% | +8.4% | **+64.6%** |
| 2024 🐂 | +11.7% | -5.8% | +76.1% | +38.2% | **+30.0%** |
| 2025 📊 | -17.1% | +46.8% | +17.3% | -28.4% | **+4.6%** |
| 2026Q1-Q2 | -14.5% | -6.5% | -30.9% | -4.4% | **-14.1%** |

> **注意**：SOL/BNB 的高回報來自 trailAtrMult=2.0 trailing stop 在大牛市（2021/2023）捕捉長趨勢（如 SOL 2021 $1.5→$260）；熊市（2022）則全面大虧，表格是歷史回測數字而非保證報酬。BTC 因波動率過濾器擋掉較多進場，trailing stop alpha 較小。
